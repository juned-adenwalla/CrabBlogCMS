...
<head>
    ...
    <!-- App title -->
    <title>Dashboard | <?php echo call_user_func('get_settings','SiteName');?></title>
                        ...
                        <a href="manage-posts.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow"
                                            title="User This Month">Live Posts</p>
                        ...
                        <a href="subscribers.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow"
                                            title="User This Month">Active Subscribers</p>
                                        <?php $query=mysqli_query($con,"select * from tblsubscribers where active=1");
$countposts=mysqli_num_rows($query);
?>
                                        <h2><?php echo htmlentities($countposts);?> <small></small></h2>
