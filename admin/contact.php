...
<html lang="en">
    <head>
        ...
        <title>Messages | <?php echo call_user_func('get_settings','SiteName');?></title>
...
<td><?php echo htmlentities($row['PostedAt']);?></td>
<td>
	&nbsp;<a href="contact.php?rid=<?php echo htmlentities($row['id']);?>&&action=del"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
</td>
</tr>
<?php
$cnt++;
