...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Admin Panel | <?php echo call_user_func('get_settings','SiteName');?></title>
                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span><img src="postimages/media/<?php echo call_user_func('get_settings','SiteLogo');?>" alt="Logo" height="36"></span>
                                        </a>
                                    </h2>
