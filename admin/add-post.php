...
?>
                                        ...
                                        <div class="form-group m-b-20">
                                            ...
                                            <textarea class="form-control" name="metadesc"
                                                required><?php echo htmlentities($row['MetaDescription'])?></textarea>
                                        </div>

                                        <div class="form-group m-b-20">
                                            <label for="exampleInputEmail1">Meta Keywords</label>
                                            <input type="text" class="form-control" id="keywords" name="metakey"
                                                value="<?php echo htmlentities($row['MetaKeywords'])?>" required>
                                        </div>
